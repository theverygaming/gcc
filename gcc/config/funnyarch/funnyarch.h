...
#define FUNNYARCH_R26    26
/* Special purpose registers */
#define FUNNYARCH_RFP    27
#define FUNNYARCH_LR     28
#define FUNNYARCH_RSP    29
#define FUNNYARCH_RIP    30
#define FUNNYARCH_RF     31 // flags register (contains CC / condition code)
/* System registers */
#define FUNNYARCH_SCR0    (32 + 0)
#define FUNNYARCH_SCR1    (32 + 1)
#define FUNNYARCH_SCR2    (32 + 2)
#define FUNNYARCH_SCR3    (32 + 3)
#define FUNNYARCH_IRIP    (32 + 4)
#define FUNNYARCH_IBPTR   (32 + 5)
#define FUNNYARCH_PCST    (32 + 6)
#define FUNNYARCH_TLBIRIP (32 + 7)
#define FUNNYARCH_TLBIPTR (32 + 8)
#define FUNNYARCH_TLBFLT  (32 + 9)
#define FIRST_PSEUDO_REGISTER (32 + 10)
...
{ { 0x00000000, 0x00000000 }, /* NO_REGS - Empty */                                                 \
  { 0x1FFFFFFF, 0x00000000 }, /* GENERAL_REGS - $r0-$r26, $rfp, $lr, $rsp */                        \
  { 0x40000000, 0x000003FF }, /* SPECIAL_REGS - $rip, all system registers (scrX, irip etc.) $ */   \
  { 0x80000000, 0x00000000 }, /* CC_REGS - $rf */                                                   \
  { 0xFFFFFFFF, 0x000003FF }  /* ALL_REGS - All registers */                                        \
}
...
#define FIXED_REGISTERS \
                        ...
                        /* r24     r25    r26  rfp     */   0, 0, 0, 1, \
                        /* lr      rsp    rip  rf      */   1, 1, 1, 1, \
                        /* scr0    scr1   scr2 scr3    */   1, 1, 1, 1, \
                        /* irip    ibptr  pcst tlbirip */   1, 1, 1, 1, \
                        /* tlbiptr tlbflt              */   1, 1 }
...
/* A C expression whose value is a register class containing hard
   register REGNO.  */
#define REGNO_REG_CLASS(R) ((R <= FUNNYARCH_RSP) ? GENERAL_REGS :                \
                            (R == FUNNYARCH_RF ? CC_REGS : SPECIAL_REGS))
...
#define PRINT_OPERAND(STREAM, X, CODE) funnyarch_print_operand (STREAM, X, CODE)

#define PRINT_OPERAND_ADDRESS(STREAM ,X) funnyarch_print_operand_address (STREAM, X)
...
#define FUNNYARCH_EXPAND_ALIGNMENT(COND, EXP, ALIGN)				\
...
#define LOCAL_ALIGNMENT(EXP, ALIGN)				\
  FUNNYARCH_EXPAND_ALIGNMENT(/*!flag_conserve_stack*/ 1, EXP, ALIGN)
...
#define STATIC_CHAIN_REGNUM  FUNNYARCH_R0 /* FIXME: this is definitely broken lmao */
...
#define ARG_POINTER_REGNUM FUNNYARCH_RFP /* FIXME: probably broken */
...
/* This macro returns the initial difference between the specified pair of registers.
   The value would be computed from information such as the result of get_frame_size ()
   and the tables of registers df_regs_ever_live_p and call_used_regs. */
#define INITIAL_ELIMINATION_OFFSET(FROM, TO, OFFSET) \
   (OFFSET) = funnyarch_initial_elimination_offset (FROM, TO)
...
#define REGNO_OK_FOR_INDEX_P(NUM) FUNNYARCH_RFP /* FIXME: donno */
...
/* Define this to be nonzero if shift instructions ignore all but the low-order
   few bits.  */
#define SHIFT_COUNT_TRUNCATED 0 /* FIXME: probably undefined, figure out! */
...
/* Define this boolean macro to indicate whether or not your architecture has conditional
   ...
   that partitions hot and cold basic blocks into separate sections of the executable.
   If this macro is set to false, gcc will convert any conditional branches that attempt
   to cross between sections into unconditional branches or indirect jumps. */
#define HAS_LONG_UNCOND_BRANCH false

/* Define this macro to be true if it is as good or better
   to call a constant function address than to call an address kept in a register. */
